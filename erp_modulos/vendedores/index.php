...
?>
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    ...
                                    ?>
                                        <button class="btn btn-outline-success" data-toggle="modal" data-target="#modalVendedores" id="newVendedor">
                                            Nuevo Vendedor
                                        </button>
                                    <?php
                                    endif;
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo ($vendedor["mothersLastname"]); ?></td>
                                                        <td><?php echo ($vendedor["lastname"]); ?></td>
                                                        <?php
                                                        ...
                                                        ?>
                                                            <td>
                                                                ...
                                                                ?>
                                                                    <button class="btnEdit mr-2 btn btn-outline-primary" data="<?php echo $vendedor['empleado_id'] ?>" data-toggle="modal" data-target="#modalVendedores">
                                                                        Editar
                                                                    </button>
                                                                <?php
                                                                endif;
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalVendedores" tabindex="-1" role="dialog" aria-labelledby="modalVendedores" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        <label for="id_perfil">Nombre</label>
                        <select name="empleado_id" id="empleado_id" class="form-control">
                            <option value="0">Seleccione un empleado</option>
                            <?php
                            $empleados = $db->select('empleados_rh',[
                                "id",
                                "name",
                                "lastname"
                            ]);
                            ...
                            ?>
                                <option value="<?php echo $empleado['id']; ?>">
                                    <?php echo ($empleado["name"]/* , $empleado["lastname"], $empleado["mothersLastaname"] */); ?>
                                </option>
                            <?php
                            }
                            ?>
