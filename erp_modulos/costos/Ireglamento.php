                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Módulo de Costos
                                    <div class="page-title-subheading">Insertar Reglamento
                                    </div>
                                </div>
                            </div>
                            <div class="page-title-actions">
                                <div class="d-inline-block dropdown">
                                    <a href="Treglamento.php"aria-haspopup="true"
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="funciones/insertarR.php" method="POST">
                                        ...
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="descripcion" id="desc" type="text" class="form-control" required>
                                        </div>
                                        <div class="position-relative form-group">
                                            <label for="reglamento" class="">Fecha de registro</label>
